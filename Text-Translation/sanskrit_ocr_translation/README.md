...
The first run downloads the selected OCR model. For offline use, configure PaddleOCR to use a local model cache.
...
GitHub:
https://github.com/AkshadKurve

Project Repository:
https://github.com/AkshadKurve/Text-Translation
